...
@Component({
  selector: 'app-adminviewcategorydetails',
  templateUrl: './adminviewcategorydetails.component.html',
  styleUrls: ['./adminviewcategorydetails.component.css']
})
export class AdminviewcategorydetailsComponent implements OnInit {
search;
  order:String='name';
